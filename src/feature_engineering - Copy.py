...
#     def impute_missing_data(dataframe:pd.DataFrame):
#         dataframe= self.fe_impute_mode(dataframe,["Onboard Wifi Service","Embarkation/Disembarkation time convenient", 
...
#         # dataframe=self.fe_impute_mean(dataframe,["Distance in KM"])
#         # dataframe=self.fe_impute_median(dataframe,["Age"])
#         # dataframe=self.fe_impute_random(dataframe, ["Gender"])
    
#     def fe_impute_mode(self,dataframe:pd.DataFrame, col_names:list)->pd.DataFrame:
#         """
